...
APPS = [
    ...
    dict(slug="hanalog", name="ハナログ", appid="6798935243", state="prepare",
         ...
         topic="毎日の記録"),
    dict(slug="zurenaikakeibo", name="ズレない家計簿", appid="6798934706", state="prepare",
         price="買い切り 120円", os="iOS 17+",
         tagline="締め日と引落日が、実際とズレない。",
         short="翌々月払いも土日祝ずれも計算する家計簿。残高は毎回すべて再計算。",
         topic="仕事の道具"),
    dict(slug="magedori", name="マゲドリ", appid="6798952257", state="prepare",
         price="買い切り 120円", os="iOS 17+",
         tagline="自分のベンダーの癖を、覚えさせる。",
         short="日本のJIS電線管専用の曲げ寸法計算。試し曲げ1回で実効芯半径を逆算。",
         topic="仕事の道具"),
    dict(slug="negotouranai", name="ねごと占い", appid="6798951966", state="prepare",
         price="無料（120円の買い切りで無制限）", os="iOS 17+",
         tagline="寝言を録って、読み解く。",
